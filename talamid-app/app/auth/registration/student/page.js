...
export default function StudentRegister() {
  ...
  const handleSignUp = (e) => {
    ...
    document.cookie = "userRole=student; path=/; max-age=604800";
      ...
      <div className="bg-white w-full max-w-[600px] rounded-[40px] shadow-sm p-10 md:p-14 border border-gray-100">
        ...
        <div className="text-center mb-10">
          <h1 className="text-[24px] md:text-[28px] font-bold text-[--color-primary-dark] leading-tight mb-8">
            Connectez-vous et accédez à des leçons illimitées en vidéos expliquées.
          </h1>
        ...
        <form className="space-y-6" onSubmit={handleSignUp}>
          ...
          <div className="flex flex-col gap-2">
            <label className="text-[14px] font-bold text-gray-700 ml-1">Votre niveau scolaire ?</label>
          ...
          <div className="flex flex-col gap-2">
            <label className="text-[14px] font-bold text-gray-700 ml-1">Votre filière ? ( facultatif )</label>
            <div className="relative">
              <select className="w-full border border-gray-200 rounded-2xl py-4 px-5 text-sm bg-white text-gray-400 focus:outline-none focus:border-[--color-primary-light] cursor-pointer">
